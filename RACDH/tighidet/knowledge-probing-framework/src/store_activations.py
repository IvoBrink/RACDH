...
MODEL_LAYERS_MAPPINGS = {
    ...
    "Meta-Llama-3.1-8B": "model.model.layers",
    "Llama-3.1-8B": "model.model.layers",
    "Qwen2.5-7B": "model.model.layers",
...
MODULE_MAPPINGS = {
    "mlp": {
        ...
        "Meta-Llama-3.1-8B": "mlp.down_proj",
        "Llama-3.1-8B": "mlp.down_proj",
        "Qwen2.5-7B": "mlp.down_proj",
    },
    "mlp-l1": {
        ...
        "Meta-Llama-3.1-8B": "mlp.act_fn",
        "Llama-3.1-8B": "mlp.act_fn",
        "Qwen2.5-7B": "mlp.act_fn",
    },
    "mhsa": {
        ...
        "Meta-Llama-3.1-8B": "self_attn.o_proj",
        "Llama-3.1-8B": "self_attn.o_proj",
        "Qwen2.5-7B": "self_attn.o_proj",
    },
}
